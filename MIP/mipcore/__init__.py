...
Submódulos:
  ...
  multiplicadores — produção, geradores, Rasmussen-Hirschman, ligações puras GHS, Tipo II.
  ...
  regional        — sistema inter-regional IIOAS (27 UFs × 68 setores, anos 2011 e 2019):
                    multiplicadores, R-H, autossuficiência, demanda final, extração por UF,
                    colapso SP×RB e fechamento Tipo II.
